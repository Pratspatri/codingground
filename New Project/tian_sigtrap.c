...
char * colours [] = { BLACK ON_WHITE, CYAN ON_RED, GREEN ON_MAGENTA,
                      ...
                      CYAN ON_MAGENTA,WHITE ON_BLACK, RED ON_CYAN,
                      MAGENTA ON_GREEN,YELLOW ON_BLUE, CYAN ON_BLACK, 
                      RED ON_WHITE,GREEN ON_BLUE, MAGENTA ON_YELLOW, 
                      GREEN ON_BLACK,RED ON_YELLOW, CYAN ON_BLUE, 
                      WHITE ON_MAGENTA,YELLOW ON_BLACK, RED ON_GREEN, 
                      WHITE ON_BLUE,MAGENTA ON_CYAN };
#define N_COLOUR 32
...
int main(int argc, char *argv[])
{
    ...
    //  signal (SIGCONT, SignalHandler);  						          // do this intrinsically after return from SIGTSTP due to												      Darwin/BSD inconsistent SIGCONT 												 behaviour
...
char * StripPath(char * pathname)
{
     ...
     {           										               // non-zero length string
      ...
      }                                      							// original must be filename only
      return NULL;
}